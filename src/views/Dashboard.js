...
const ImageLoader = ({ photo }) => {
  if (photo == null) {
    return (
      <div className="d-flex skeleton w-100" style={{ height: 150 }}>
    ...
    return (
      <img
        className={"rounded " + (photo == null && "skeleton")}
    ...
    <div className="col-11 col-sm-5 mx-4 col-md-3 mb-5 rounded shadow-4 p-0 image-card d-flex flex-column justify-content-between">
      ...
      <div className="d-flex flex-row p-3 justify-content-between">
        ...
        <div className="d-flex ms-1 flex-column text-end">
          ...
          <div
            className={
              "font-noto fw-bold d-flex flex-row " +
              (sessionReducer.price == 0 && "skeleton")
            }
          >
            {sessionReducer.price != 0 &&
              (product.price / sessionReducer.price).toFixed(6)}
            {sessionReducer.price != 0 && (
